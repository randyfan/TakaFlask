...
def get_translate(cum_utterances):
    ...
    translations = translator.translate(cum_utterances, lang_src='en',
                                        lang_tgt='fr')  # https://stackoverflow.com/questions/65144681/attributeerror-nonetype-object-has-no-attribute-group-googletrans-python
